...
public class Ventana extends javax.swing.JFrame {
    ...
    private void buscarElectrodomestico() {
        ...
        if (rutaArchivo.exists()) {
            ...
            if (crearelec.exists() && BAelectrodomestico.exists()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "El electrodomestico no existe, verifique que haya colocado bien la informacion");
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "La cedula no existe, verifique que haya colocado bien la informacion");
        }
    }
        ...
        if (rutaArchivo.exists()) {
            ...
            if (BAelectrodomestico.exists()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "No se ha podido eliminar el electrodomestico.");
                }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, -20, 1080, 120));
