...
public class VentanaElectrodomestico extends javax.swing.JFrame {
    ...
    private void registrarElectrodomestico() {
        ...
        if (rutaArchivo.exists()) {
            ...
            if (crearelec.exists()) {
                JOptionPane.showMessageDialog(rootPane, "el electrodomestico existe");
            } else {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 480, -1, -1));
        ...
        jPanel1.add(botonBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 480, 110, -1));
        ...
        jPanel1.add(botonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 480, -1, -1));
